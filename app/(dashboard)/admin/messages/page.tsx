...
import { MessageSquare, Search, Send, User, UserCircle } from "lucide-react";
...
export default function AdminMessagesPage() {
  ...
  const searchResults = useQuery(
    ...
    searchQuery.trim().length > 0 ? { searchQuery: searchQuery.trim(), limit: 10 } : "skip"
  );
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* User Search & Conversations List */}
        <div className="lg:col-span-1 space-y-4">
          {/* Search */}
          <Card className="bg-white border-burgundy/10">
            <CardHeader>
              <CardTitle className="text-lg text-burgundy">Search Users</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          {searchQuery.trim().length > 0 && (
            <Card className="bg-white border-burgundy/10">
              <CardHeader>
                <CardTitle className="text-lg text-burgundy">Search Results</CardTitle>
              </CardHeader>
              <CardContent>
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-medium text-burgundy truncate">{user.name}</p>
          ...
          {(!searchQuery || searchQuery.trim().length === 0) && (
            <Card className="bg-white border-burgundy/10">
              <CardHeader>
                <CardTitle className="text-lg text-burgundy">Recent Conversations</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          {selectedUser ? (
            ...
            <Card className="bg-white border-burgundy/10 h-[600px] flex items-center justify-center">
              <CardContent className="text-center">
                ...
                <h3 className="text-xl font-semibold text-burgundy mb-2">Select a user to message</h3>
                <p className="text-burgundy/70">
                  Search for a user above or select from recent conversations
                </p>
              </CardContent>
            </Card>
          )}
