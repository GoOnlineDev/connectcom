    ...
    <div className="min-h-screen bg-beige">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <Card className="border-burgundy/20 mb-8">
          ...
          <CardContent>
            <div className="bg-burgundy/5 rounded-lg p-4 md:p-6">
              <h3 className="font-semibold text-burgundy mb-3">Our Commitment to You</h3>
              <p className="text-burgundy/80 text-sm md:text-base">
        ...
        <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="border-burgundy/20">
            ...
            <CardContent className="space-y-3 text-sm md:text-base">
              ...
              <ul className="space-y-2 text-burgundy/70">
              ...
              <p className="text-burgundy/80 text-xs md:text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-burgundy/80 text-sm md:text-base">privacy@connectcom.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <Globe className="w-4 h-4 text-burgundy" />
                  <span className="text-burgundy/80 text-sm md:text-base">www.connectcom.com/support</span>
                </div>
              </div>
        ...
        <div className="mt-8 md:mt-12 text-center">
          <Card className="border-burgundy/20 bg-gradient-to-r from-burgundy/5 to-burgundy/10 max-w-2xl mx-auto">
            <CardContent className="pt-6">
              <h3 className="font-semibold text-burgundy mb-3">Policy Updates</h3>
