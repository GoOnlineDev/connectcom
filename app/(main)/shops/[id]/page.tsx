...
export default function ShopPage({ params }: ShopPageProps) {
  ...
  return (
    <div className="min-h-screen bg-beige">
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="lg:col-span-2">
              ...
              {isEditMode && isOwner && isVendor && (
                <div className="mb-4 p-4 bg-burgundy/10 border border-burgundy/20 rounded-lg">
                  <div className="flex items-center gap-2">
                    <Edit3 className="w-5 h-5 text-burgundy" />
                    <div>
                      <h4 className="font-semibold text-burgundy">Edit Mode Active</h4>
                      <p className="text-sm text-burgundy/80">You can now manage your shop content and shelves.</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <div className="flex items-center justify-between mb-6">
                  ...
                  {isOwner && isVendor && (
                    <Button
                      ...
                      className={isEditMode ? "bg-burgundy hover:bg-burgundy-dark" : "border-burgundy text-burgundy hover:bg-burgundy/10"}
                    >
                ...
                <TabsContent value="products" className="space-y-6">
                  ...
                  {isOwner && isVendor && shelfLimits && (
                    <Card className="border-burgundy/20 bg-gradient-to-r from-burgundy/5 to-burgundy/10">
                      <CardHeader>
                      ...
                      <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div className="text-center">
                            ...
                            <div className="text-burgundy/80">Shelves Used</div>
                          </div>
                          <div className="text-center">
                            <div className="text-lg font-semibold text-burgundy capitalize">
                              {shelfLimits.packageName}
                            </div>
                            <div className="text-burgundy/80">Current Plan</div>
                          </div>
                          <div className="text-center">
                          ...
                          <Dialog open={isShelfDialogOpen} onOpenChange={setIsShelfDialogOpen}>
                            ...
                            <DialogContent>
                              ...
                              <DialogFooter>
                                ...
                                <Button onClick={handleCreateShelf} className="bg-burgundy hover:bg-burgundy-dark">
                                  Create Shelf
                                </Button>
                              </DialogFooter>
                            </DialogContent>
                                  ...
                                  <div>
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      {uploadedImages.length > 0 && (
                                        <div>
                                          <div className="text-sm font-medium text-burgundy mb-2">
                                            ...
                                            {uploadedImages.map((url, index) => (
                                              <div key={index} className="relative group">
                                                <img
                                                  src={url}
                                                  alt={`Upload ${index + 1}`}
                                                  className="w-full h-20 object-cover rounded-lg border border-burgundy/20"
                                                />
                                                <button
                                                  type="button"
                                                  onClick={() => {
                ...
                <TabsContent value="about" className="space-y-6">
                  <Card className="border-burgundy/20">
                    <CardHeader>
                      <CardTitle className="text-burgundy">About {shopData.shopName}</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      {shopData.description ? (
                        ...
                        <p className="text-burgundy/60 italic">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <h4 className="font-semibold text-burgundy mb-3">Shop Information</h4>
                          <div className="space-y-2">
                            ...
                            {shopData.categories && shopData.categories.length > 0 && (
                              <div>
                                <p className="text-sm text-burgundy/70 mb-2">Categories:</p>
                                <div className="flex flex-wrap gap-1">
                                  {shopData.categories.map((category) => (
                                    <Badge key={category} variant="outline" className="text-xs border-burgundy/30 text-burgundy">
                                      {category}
                                    </Badge>
                                  ))}
                                </div>
                        ...
                        {shopData.operatingHours && (
                          <div>
                            <h4 className="font-semibold text-burgundy mb-3">Operating Hours</h4>
                            <div className="flex items-start gap-2">
                              <Clock className="w-4 h-4 text-burgundy/70 mt-0.5" />
                ...
                <TabsContent value="contact" className="space-y-6">
                  <Card className="border-burgundy/20">
                    <CardHeader>
                      <CardTitle className="text-burgundy">Contact {shopData.shopName}</CardTitle>
                      <CardDescription>
                    ...
                    <CardContent className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="space-y-3">
                            {shopData.contactInfo?.phone && (
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm text-burgundy/80">{shopData.contactInfo.phone}</span>
                              </div>
                            )}
                            ...
                            {shopData.contactInfo?.email && (
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm text-burgundy/80">{shopData.contactInfo.email}</span>
                              </div>
                            )}
                        ...
                        {shopData.physicalLocation && (
                          <div>
                            <h4 className="font-semibold text-burgundy mb-3">Location</h4>
                      ...
                      <div className="space-y-4">
                        <h4 className="font-semibold text-burgundy">Get in Touch</h4>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-burgundy/20 shadow-lg p-4 lg:hidden">
        <div className="flex gap-2">
          <Button 
            onClick={() => setActiveTab("products")} 
            variant={activeTab === "products" ? "default" : "outline"}
            className={`flex-1 ${activeTab === "products" ? "bg-burgundy hover:bg-burgundy-dark" : "border-burgundy text-burgundy hover:bg-burgundy/10"}`}
            size="sm"
          >
          ...
          <Button 
            ...
            className={`flex-1 ${activeTab === "about" ? "bg-burgundy hover:bg-burgundy-dark" : "border-burgundy text-burgundy hover:bg-burgundy/10"}`}
            size="sm"
          >
          ...
          <Button 
            ...
            className={`flex-1 ${activeTab === "contact" ? "bg-burgundy hover:bg-burgundy-dark" : "border-burgundy text-burgundy hover:bg-burgundy/10"}`}
            size="sm"
          >
            <MessageCircle className="w-4 h-4 mr-2" />
            Contact
      ...
      <Card className="border-burgundy/20">
        <CardContent className="p-6">
          <div className="animate-pulse flex space-x-4">
            <div className="rounded-full bg-burgundy/20 h-4 w-4"></div>
            <div className="flex-1 space-y-2">
              <div className="h-4 bg-burgundy/20 rounded w-1/4"></div>
              <div className="h-3 bg-burgundy/20 rounded w-1/2"></div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg text-burgundy">{shelf.shelfName}</CardTitle>
      ...
      <CardContent>
        {items.length > 0 ? (
          <div className="relative">
            ...
            <div className="flex overflow-x-auto gap-4 pb-4 scrollbar-thin scrollbar-track-burgundy/10 scrollbar-thumb-burgundy/30 hover:scrollbar-thumb-burgundy/50">
              {items.map((item) => (
                <Card key={item._id} className="flex-shrink-0 w-64 hover:shadow-md transition-shadow border-burgundy/20 relative group">
                  <div className="h-32 bg-gradient-to-br from-beige to-beige-dark rounded-t-lg relative">
                    {shopType === 'product_shop' && 'imageUrls' in item && item.imageUrls && item.imageUrls.length > 0 ? (
                      ...
                      <div className="flex items-center justify-center h-full">
                        {shopType === 'product_shop' ? (
                          <ShoppingBag className="w-8 h-8 text-burgundy/40" />
                        ) : (
                  ...
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-semibold line-clamp-2 text-burgundy">
                      {item.name}
                    </CardTitle>
                  </CardHeader>
                  ...
                  <CardContent className="pt-0">
                    {item.description && (
                      <CardDescription className="text-xs line-clamp-3 mb-3 text-burgundy/70">
                        {item.description}
                      </CardDescription>
                    )}
          ...
          <div className="text-center py-8 text-burgundy/60">
            <Package className="mx-auto h-12 w-12 text-burgundy/40 mb-2" />
