...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen bg-beige">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-burgundy to-burgundy-dark text-white py-12 md:py-16">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <Card className="border-burgundy/20 mb-8">
          ...
          <CardContent>
            <Alert className="border-burgundy/20 bg-burgundy/5">
              ...
              <AlertDescription className="text-burgundy/80">
        ...
        <div className="space-y-6 md:space-y-8">
          {sections.map((section, index) => {
            ...
            return (
              <Card key={section.id} className="border-burgundy/20">
                <CardHeader>
                  <CardTitle className="text-burgundy flex items-center gap-3 text-lg md:text-xl">
                ...
                <CardContent>
                  <ul className="space-y-3">
                    {section.content.map((item, itemIndex) => (
                      <li key={itemIndex} className="flex items-start gap-3 text-burgundy/80 text-sm md:text-base">
            ...
            <CardContent>
              <ul className="space-y-3">
                {userRights.map((right, index) => (
                  <li key={index} className="flex items-start gap-3 text-burgundy/80 text-sm md:text-base">
            ...
            <CardContent>
              <ul className="space-y-3">
                {userResponsibilities.map((responsibility, index) => (
                  <li key={index} className="flex items-start gap-3 text-burgundy/80 text-sm md:text-base">
                    <Gavel className="w-4 h-4 text-burgundy mt-0.5 flex-shrink-0" />
        ...
        <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="border-burgundy/20">
            ...
            <CardContent className="space-y-4 text-sm md:text-base">
              <div className="bg-burgundy/5 rounded-lg p-4">
                <h4 className="font-semibold text-burgundy mb-2">Shop Approval Process</h4>
              ...
              <div className="bg-burgundy/5 rounded-lg p-4">
                <h4 className="font-semibold text-burgundy mb-2">Quality Standards</h4>
                <p className="text-burgundy/80 text-sm">
          ...
          <Card className="border-burgundy/20">
            ...
            <CardContent className="space-y-4 text-sm md:text-base">
              <div className="bg-burgundy/5 rounded-lg p-4">
                <h4 className="font-semibold text-burgundy mb-2">Safe Shopping</h4>
                <p className="text-burgundy/80 text-sm">
              ...
              <div className="bg-burgundy/5 rounded-lg p-4">
                <h4 className="font-semibold text-burgundy mb-2">Dispute Resolution</h4>
                <p className="text-burgundy/80 text-sm">
        ...
        <Card className="border-burgundy/20 mt-8 md:mt-12">
          <CardHeader>
            <CardTitle className="text-burgundy flex items-center gap-2">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-burgundy mb-3">Violations</h4>
                <ul className="space-y-2 text-burgundy/80 text-sm md:text-base">
              ...
              <div>
                <h4 className="font-semibold text-burgundy mb-3">Your Rights</h4>
                <ul className="space-y-2 text-burgundy/80 text-sm md:text-base">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-burgundy/80 text-sm md:text-base">legal@connectcom.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <Globe className="w-4 h-4 text-burgundy" />
                  <span className="text-burgundy/80 text-sm md:text-base">www.connectcom.com/legal</span>
                </div>
                <div className="text-xs md:text-sm text-burgundy/70">
        ...
        <div className="mt-8 md:mt-12 text-center">
          <Card className="border-burgundy/20 bg-gradient-to-r from-burgundy/5 to-burgundy/10 max-w-3xl mx-auto">
            <CardContent className="pt-6">
              <h3 className="font-semibold text-burgundy mb-3">Changes to Terms</h3>
              <p className="text-burgundy/80 text-sm md:text-base mb-4">
              ...
              <p className="text-burgundy/70 text-xs md:text-sm">
